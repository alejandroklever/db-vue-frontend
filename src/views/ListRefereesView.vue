                        ...
                        <template v-slot:header>
                            <v-toolbar dark color="primary" class="mb-1">
                                ...
                                <template v-if="$vuetify.breakpoint.mdAndUp">
                                    <v-spacer></v-spacer>
                                    <v-select
                                        v-model="sortByCredentials"
                                        flat
                                        solo-inverted
                                        hide-details
                                        :items="keys_sortby_credentials"
                                        prepend-inner-icon="mdi-magnify"
                                        label="Ordenar por"
                                    ></v-select>
                                    <v-spacer></v-spacer>
                                    ...
                                    <v-card>
                                        ...
                                        <v-row>
                                            ...
                                            <v-combobox
                                                ...
                                                :items="evaluation"
                                                label="Seleccione la evaluación deseada"
                                                outlined
                                                persistent-hint
                                                dense
                                                >
...
export default class ListRefereesView extends Vue {
    private page = 1
    private search = ''
    private keys_sortby_credentials = ['título', 'autor']
    private keys_sortby_status = ['enviados', 'pendientes', 'recientes']
    private sortByCredentials = ''
    ...
    private evaluation = ['Aceptado', 'Aceptado con cambios menores', 'Aceptado con cambios mayores', 'Denegado']
